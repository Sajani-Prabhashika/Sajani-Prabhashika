...
A full-stack leisure and hotel-related application involving **Flutter, .NET, APIs, databases, authentication, and payment-related functionality**.

**Technologies:** Flutter • .NET • SQL • REST APIs • Git

---

### 🔧 FixIt

A Flutter-based booking application designed to connect users with services through a mobile-friendly booking experience.

**Technologies:** Flutter • Dart • APIs • Database

---

### 🏛️ OneGov

A mobile application developed using **React Native** with a backend for handling application data and services.

**Technologies:** React Native • Node.js • APIs • Database
...
I'm particularly interested in becoming stronger in **backend architecture, API development, database design, authentication, security, and scalable applications**.
...
<p>
  <a href="https://github.com/Sajani-Prabhashika">
    <img src="https://img.shields.io/badge/GitHub-Sajani--Prabhashika-181717?style=for-the-badge&logo=github"/>
  </a>
</p>
